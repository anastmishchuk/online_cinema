...
class TestUserRegistrationAndActivation:
    ...
    async def test_register_user(self, async_client: AsyncClient, valid_user_data: dict, create_user_groups):
    ...
    async def test_register_duplicate_email(self, async_client: AsyncClient, test_user: User, valid_user_data: dict):
    ...
    async def test_register_invalid_data(self, async_client: AsyncClient, invalid_user_data: dict):
        """Test registration with invalid data."""
        response = await async_client.post("/api/v1/users/register", json=invalid_user_data)
        assert response.status_code == 422  # Validation error

    async def test_activate_user_with_token(self, async_client: AsyncClient, inactive_user_with_token: User):
    ...
    async def test_activate_user_with_invalid_token(self, async_client: AsyncClient):
    ...
    async def test_activate_via_link(self, async_client: AsyncClient, inactive_user_with_token: User):
    ...
    async def test_activate_via_link_invalid_token(self, async_client: AsyncClient):
        """Test user activation via GET link with invalid token."""
        response = await async_client.get("/api/v1/users/activate/invalid_token")
        assert response.status_code == 400
        assert "Invalid or expired activation token" in response.json()["detail"]

    async def test_resend_activation_email(self, async_client: AsyncClient, inactive_user: User):
    ...
    async def test_resend_activation_email_user_not_found(self, async_client: AsyncClient):
    ...
    async def test_resend_activation_email_already_active(self, async_client: AsyncClient, test_user: User):
...
class TestUserProfileEndpoints:
    ...
    async def test_get_current_user_profile(self, authenticated_client: AsyncClient, test_user_with_profile: User):
    ...
    async def test_get_profile_creates_if_not_exists(self, authenticated_client: AsyncClient, test_user: User):
    ...
    async def test_update_user_profile(self, authenticated_client: AsyncClient, test_user_with_profile: User):
    ...
    async def test_get_user_favorites(self, authenticated_client: AsyncClient, test_user_with_favorites: User):
    ...
    async def test_get_user_favorites_with_filters(self, authenticated_client: AsyncClient,
    ...
    async def test_get_user_purchases(self, authenticated_client: AsyncClient, test_user_with_purchases: User):
    ...
    async def test_get_user_favorites_empty(self, authenticated_client: AsyncClient, test_user_no_favorites: User):
    ...
    async def test_get_user_purchases_empty(self, authenticated_client: AsyncClient, test_user_no_purchases: User):
    ...
    async def test_get_purchases_unauthorized(self, async_client: AsyncClient):
...
class TestAdminEndpoints:
    ...
    async def test_admin_activate_user(self, admin_client: AsyncClient, inactive_user: User):
    ...
    async def test_admin_activate_already_active_user(self, admin_client: AsyncClient, test_user: User):
    ...
    async def test_admin_activate_non_existent_user(self, admin_client: AsyncClient):
        """Test admin activating a non-existent user."""
        response = await admin_client.post("/api/v1/users/99999/admin-activate")
        assert response.status_code == 404
        assert "User not found" in response.json()["detail"]

    async def test_admin_activate_unauthorized(self, authenticated_client: AsyncClient, inactive_user: User):
    ...
    async def test_change_user_role(self, admin_client: AsyncClient, test_user: User):
    ...
    async def test_change_user_role_unauthorized(self, authenticated_client: AsyncClient, test_user: User):
    ...
    async def test_change_role_non_existent_user(self, admin_client: AsyncClient):
    ...
    async def test_admin_get_user_profile(self, admin_client: AsyncClient, test_user_with_profile: User):
    ...
    async def test_admin_get_user_profile_unauthorized(self, authenticated_client: AsyncClient, test_user: User):
        """Test non-admin trying to get user profile."""
        response = await authenticated_client.get(f"/api/v1/users/{test_user.id}/profile")
        assert response.status_code == 403

    async def test_admin_get_user_favorites(self, admin_client: AsyncClient, test_user_with_favorites: User):
    ...
    async def test_admin_get_user_favorites_unauthorized(self, authenticated_client: AsyncClient, test_user: User):
...
class TestUserDatabase:
    ...
    async def test_create_user(self, db_session: AsyncSession, user_group: int):
    ...
    async def test_user_relationships(self, test_user_with_profile: User):
    ...
    async def test_user_activation_token_relationship(self, inactive_user_with_token: User):
...
class TestErrorHandling:
    ...
    async def test_profile_update_with_invalid_data(self, authenticated_client: AsyncClient):
    ...
    async def test_activation_with_empty_token(self, async_client: AsyncClient):
        """Test activation with empty token."""
        activation_data = {"token": ""}
        response = await async_client.post("/api/v1/users/activate", json=activation_data)
        assert response.status_code == 400

    async def test_role_change_with_invalid_role(self, admin_client: AsyncClient, test_user: User):
